...
import transformer # rescoring for gbt2
...
the future, please move to the new IO !!!
    ...
    parser.add_argument('--reverse_weight',
                        ...
                        help='''right to left weight for attention rescoring
                                decode mode''')
    # rescoring for gbt2
    parser.add_argument('--lm_model_path',required=False, help='language model path')
    #parser.add_argument('--lamb', required=False,help='weight for language model')
    ...
    dataset_conf['max_length'] = 10240
    dataset_conf['min_length'] = 1
    ...
    if args.lm_model_path:
        lm_model = transformer.modeling_gpt2.GPT2LMHeadModel.from_pretrained(args.lm_model_path)
        lm_model.to(device)
    else:
        lm_model = None
